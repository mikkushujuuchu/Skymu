...
namespace Fluxer.Networking.Managers
{
    internal class ConfigManager
    {
        ...
        public string DeviceName { get; set; } = string.Empty; // Fluxer leaves this empty for some reason?
        ...
        // Fluxer related options
        public bool HasClientMods { get; set; } = false; // Fluxer uses this in the XSP, don't know why they need this.
        public string DCReferrer { get; set; } = string.Empty;
        public string DCReferringDomain { get; set; } = string.Empty;
        public string DCReferringCurrent { get; set; } = "https://fluxer.com/";
        public string DCReferringCurrentDomain { get; set; } = "fluxer.com";
        ...
        // These functions below were rewritten from the source code of Fluxer Messenger, the exact file can be found here:
        // https://github.com/FluxerMessenger/dm/blob/master/src/core/config/FluxerClientConfig.cpp
